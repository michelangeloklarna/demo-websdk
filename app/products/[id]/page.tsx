        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-4 gap-4">
                {[...Array(4)].map((_, i) => (
                  <div
                    key={i}
                    className="aspect-square overflow-hidden rounded-lg bg-muted border-2 border-transparent hover:border-primary cursor-pointer transition-colors"
                  >
                    <Image
                      src={product.image}
            ...
            <div className="space-y-6">
              <div>
                <Badge className="mb-3 bg-primary text-primary-foreground">New Arrival</Badge>
                ...
                <div className="flex items-baseline gap-3 mb-6">
                  ...
                  <Badge variant="destructive">
                    Save{" "}
                    {Math.round(
                      ((product.price * 1.2 - product.price) / (product.price * 1.2)) * 100
                    )}
                    %
                  </Badge>
                </div>
...
function getProductDescription(productId: number): string {
  ...
  return (
    descriptions[productId as keyof typeof descriptions] ||
    "Premium tech accessory designed for modern lifestyles."
  )
}
